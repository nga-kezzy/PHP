	...
	<div id="contents">
		<div class="section">
			...
			<form action="index.html" method="post" class="message">
				<input type="text" value="Name" name="txt_name" onFocus="this.select();" onMouseOut="javascript:return false;" />
				<input type="text" value="Email" name="txt_email" onFocus="this.select();" onMouseOut="javascript:return false;" />
				<input type="text" value="Subject" name="txt_subject" onFocus="this.select();" onMouseOut="javascript:return false;" />
